...
import Transporter.TransporterFederate;
 ...
 */
public class PreparerFederateAmbassador extends NullFederateAmbassador
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	//                   INSTANCE VARIABLES
	//----------------------------------------------------------
	private PreparerFederate federate;
	...
	public PreparerFederateAmbassador(PreparerFederate federate )
	{
...
//				builder.append( "\tcount Value=" + countValue );
				if( interactionClass.equals(federate.transportMaterialHandle) )
				{
					Stock.getInstance().getFrom(countValue);
				}
